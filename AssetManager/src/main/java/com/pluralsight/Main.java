...
import com.pluralsight.model.Cash;
...
//        Cannot be instantiated because of the keyword abstract
//        Asset asset = new Asset()

        Cash cash = new Cash("My Money", LocalDateTime.now(), 12);
        ...
        System.out.println(" " + cash.getDateAcquired());
        System.out.println(" " + cash.getOriginalCost());
